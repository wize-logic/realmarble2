...
var base_acceleration: float = 25.0  # Base acceleration rate - gradual buildup
var current_acceleration: float = 25.0  # Level-scaled acceleration
var deceleration: float = 20.0  # Deceleration rate when no input - grippy stop
var turn_speed_retention: float = 0.7  # Speed kept when turning 90 degrees - lower = more grip
...
func _physics_process(delta: float) -> void:
	...
	if input_dir != Vector2.ZERO:
		...
		var min_force: float = current_roll_force * 0.6 * control_multiplier
